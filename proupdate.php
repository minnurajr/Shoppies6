...
<body>
	...
	<div class="container">
		...
		<nav class="py-3 d-lg-flex">
			<div id="logo">
				<h1> <a href=""><span class="fa fa-gift"></span> SHOPPIE </a></h1>
...
<form name="form1" action="update.php" method="post">
				<div class="row form-group"  style="margin-top: 50px;padding-left: 40px;">
					<?php
$se=" select * from productsn,stock  where stock.stock1='0' && stock.prodid=productsn.prodid";
...
?>
				<center>	<table border="1" style="width: 75%;">
						<tr style="height: 40px">
							...
							<th style=" padding-left: 20px;">Update</th>
...
<td style="font-size: 15px;"> 
  ...
  <input type="text"  name="s" id="s" readonly style="display:none"  value="<?php echo $row['size'];?>" required="">
  <input type="text" name="no" id="no" pattern="[0-9]+(\.[0-9][0-9]?)?"  maxlength="4" placeholder="No of items">
...
?>	
 ...
 else
 {
	 echo "
  					...
  					<strong>Oops!</strong> No products to updates!
				</div>
 		";
 }
